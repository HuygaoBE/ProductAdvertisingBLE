...
class TestAdvertisement(Advertisement):
    ...
    def __init__(self, bus, index):
        ...
        f = open("catalogue.txt",'r',encoding = 'utf-8')
        Catalogue = f.read()
        f.close()
#        text = f1.rstrip("\n")
#------------------------------------
...
#        print("MF:",type(MF))
        i = 0
        AdvLen = 15
        split_str = [Catalogue[i : i+AdvLen] for i in range(HeaderClose + 1, len(Catalogue), AdvLen)]
...
#------------------------------------
        with open('catalogue.txt', 'w+') as k:
            k.writelines(HeaderOut + Catalogue_W)
            k.close()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--timeout', default=7, type=int, help="advertise " +
