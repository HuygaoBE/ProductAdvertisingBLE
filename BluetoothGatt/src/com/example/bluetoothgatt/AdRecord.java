...
public class AdRecord {
    ...
    /*
     * No` lay du lieu tu bang ghi(onLeScan/main) quet do va phan tich no lam 3
     * phan tu - ma dinh danh - kieu do dai - tai trong cho moi cau truc quang cao.
     */
    public static List<AdRecord> parseScanRecord(byte[] scanRecord) {
        //kiểu của biến là List<String>; kiểu của giá trị là ArrayList<String>
